...
Aurora is a pastel family, not a scale. Used as stage colours for merch, drops, photography backdrops, and as the brand's multi-colour indicator (progress bars, active states, primary conversion moments). Never as a chaotic decorative wash. Never replaces Firefly Green / Saffron Gold as the core identity anchor.
...
- Use Luckiest Guy for more than one expressive peak per screen (the hero h1 only)
...
**Fonts:** Luckiest Guy (display, hero only) · Bubblegum Sans (headings) · Nunito (body + UI) · JetBrains Mono (code)
**Grid:** 4px base · max width 1280 · mobile gutter 24, desktop gutter 48
**Radius anchors:** 8px buttons / inputs · 12px cards · 24px spotlight/featured · 9999 pills
...
## Implementation — Tailwind CDN config
  ...
  theme: {
    extend: {
      colors: {
        night: {
          DEFAULT: '#1A2210',
          50: '#EEF2EA', 100: '#D4DFC5', 200: '#A8BF8F', 300: '#7C9F5F',
          400: '#558036', 500: '#3D6026', 600: '#2E4720', 700: '#22361A',
          800: '#1A2210', 950: '#0D1208'
        },
        firefly: {
          DEFAULT: '#A8D832',
          50: '#F5FAE6', 100: '#E8F3C4', 200: '#D3E889', 300: '#BDDE5A',
          400: '#A8D832', 500: '#8FBD28', 600: '#759E20', 700: '#5A7C18',
          800: '#405810', 950: '#1F2C08'
        },
        saffron: {
          DEFAULT: '#F5A623',
          50: '#FEF7EC', 100: '#FDE9C5', 200: '#FAD28A', 300: '#F8BC58',
          400: '#F5A623', 500: '#D88C1A', 600: '#B37010', 700: '#8A5510',
          800: '#5E3A0C', 950: '#2F1D06'
        },
        brown: {
          DEFAULT: '#7B4A2D',
          50: '#FAF3EC', 100: '#F0DCC4', 200: '#DBBA92', 300: '#C39866',
          400: '#A7764A', 500: '#8B5C38', 600: '#7B4A2D', 700: '#5F3A24',
          800: '#42281A', 950: '#1F120C'
        },
        cream: {
          DEFAULT: '#FAF3E2',
          50: '#FEFCF7', 100: '#FDF8EB', 200: '#FAF3E2', 300: '#F4E8C8',
          400: '#EBD9A6', 500: '#D9C286', 600: '#B9A365', 700: '#948048',
          800: '#6B5C34', 950: '#342D1A'
        },
        aurora: {
          rose: '#F9C4CC', peach: '#FAC9A8', butter: '#FAF0A0',
          mint: '#B8F0C4', sky: '#A8D8F5', lavender: '#D4BEF5'
        }
      },
      fontFamily: {
      ...
      boxShadow: {
        'glow-firefly': '0 4px 20px rgba(168, 216, 50, 0.40)',
        'glow-saffron': '0 4px 20px rgba(245, 166, 35, 0.35)',
        'card-hover': '0 4px 12px rgba(26, 34, 16, 0.14)',
        'modal': '0 16px 40px rgba(26, 34, 16, 0.24)',
        'section': '0 8px 24px rgba(26, 34, 16, 0.18)'
      },
      keyframes: {
...
```html
<link href="https://fonts.googleapis.com/css2?family=Bubblegum+Sans&family=Luckiest+Guy&family=Nunito:wght@400;600;700;800;900&display=swap" rel="stylesheet" />
```

## Implementation — Focus ring

```css
:focus-visible {
  outline: none;
  box-shadow: 0 0 0 3px rgba(168, 216, 50, 0.35);
}
```
